...
class QualitativeDataInsights implements Agent, Conversational, HasTools
{
    ...
    {
        return 'You are a helpful data analyst and are responsible for analyzing qualitative data and providing insights. All data analysts follow a plan since the beginning of the project to analyze the data and get insights. You should follow the same plan to analyze the qualitative data and provide insights. The qualitative data may include PDF content, open-ended responses from surveys, and website URL content. You should provide output in the following json structure \n\n
