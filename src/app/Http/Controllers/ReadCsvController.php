...
Use semantic HTML structure and Tailwind  utility classes when outputting code or HTML-like sections.
...
Use heroicons svgs for icons.';
    ...
    {
       return $prompt = $this->standardHeader. $this->getCsvData().'\n\n'. $this->getRules(). $this->standardHtmlFormat.$this->standardFooter.'> ```json';
    }
    public function getCsvData()
    {
       ...
       // Get all records as associative arrays
        ...
        return $json_object=response()->json($records);
    }
    public function getRules()
    {
        return $rules = 'Please generate a comprehensive impact survey report with THIS SPECIFIC STRUCTURE, VISUAL STYLE, and VOICE, using ONLY the provided pre,mid, post survey data:
